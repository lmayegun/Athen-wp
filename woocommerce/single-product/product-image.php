...
<div class="images clr">
	...
	if ( $attachments && count( $attachments ) > 1 && ! $product->has_child() ) :
		...
		$data_atributes                              = apply_filters( 'athen_shop_single_slider_data', $data_atributes );
		$data_atributes_html                         = '';
					...
					foreach ( $attachments as $attachment ) : ?>
						...
						<?php if ( $thumbnail ) : ?>
							...
							<div class="wpex-slider-slide sp-slide">
								...
								<a href="<?php echo athen_get_lightbox_image( $attachment ); ?>" title="<?php echo $attachment_alt; ?>" data-title="<?php echo $attachment_alt; ?>" data-type="image" class="lightbox-group-item">
									<?php echo $thumbnail; ?>
								</a>
	...
	<?php elseif ( has_post_thumbnail() ) : ?>
		...
		$image          = athen_get_post_thumbnail( array(
			'size'  => 'shop_single',
			'title' => athen_get_esc_title(),
		) );
		...
		if ( $product->has_child() ) { ?>
			...
			<div class="product-variation-thumbs clr lightbox-group">
				...
				<?php foreach ( $attachments as $attachment ) : ?>
					...
					// Get thumbnail
					$args       = apply_filters( 'athen_woo_variation_thumb_args', array(
						'attachment'    => $attachment,
						'size'          => 'shop_single',
					) );
