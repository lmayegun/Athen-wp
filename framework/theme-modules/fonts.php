 ...
 * 
 * Description  : Bunch of functions that modify fonts.  
 * 
 * @package     Athen
 ...
 * @since Total 1.5.2
 */
if ( ! function_exists( 'athen_font_awesome_css_url' ) ) {
	function athen_font_awesome_css_url() {
		return ATHEN_CSS_DIR_URI .'font-awesome.min.css';
	}
}
 ...
 * @return array
 */
if ( ! function_exists( 'athen_get_awesome_icons' ) ) { 
	function athen_get_awesome_icons() {
		...
		return apply_filters( 'athen_get_awesome_icons', $icons );
	}
}
 ...
 * @return array
 */
function athen_get_meta_awesome_icons() {
	$awesome_icons = athen_get_awesome_icons();
	$return_array = array();
 ...
 * @return string
 */
function athen_post_format_icon() {
	...
	$icon = apply_filters( 'athen_post_format_icon', $icon );
 ...
 * @since Total 1.0.0
 */
if ( ! function_exists( 'athen_standard_fonts' ) ) {
	function athen_standard_fonts() {
		return array(
 ...
 * @since 1.6.0
 */
function athen_google_fonts_array() {
	...
	return apply_filters( 'athen_google_fonts_array', $fonts );
}
 ...
 * @return array
 */
function athen_enqueue_google_font( $font ) {
