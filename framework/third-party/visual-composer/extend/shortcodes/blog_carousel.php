...
if ( ! function_exists( 'vcex_blog_carousel_shortcode_vc_map' ) ) {
    ...
    function vcex_blog_carousel_shortcode_vc_map() {
        ...
        // Add VC params
        vc_map( array(
            'name'          => __( 'Blog Carousel', 'athen_transl' ),
            'description'   => __( 'Recent blog posts carousel', 'athen_transl' ),
            ...
            'params'        => array(
                ...
                array(
                    ...
                    'group'             => __( 'Title', 'athen_transl' ),
                    'description'       => __( 'Select a custom color to override the default.', 'athen_transl' ),
                ),
                array(
                    'type'          => 'textfield',
