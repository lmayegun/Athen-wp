...
if ( ! function_exists( 'vcex_image_galleryslider_shortcode_vc_map' ) ) {
    function vcex_image_galleryslider_shortcode_vc_map() {
        vc_map( array(
            'name'                  => __( 'Gallery Slider', 'athen_transl' ),
            'description'           => __( 'Image slider with thumbnail navigation', 'athen_transl' ),
            ...
            'params'                => array(
                ...
                array(
                    ...
                    'std'           => '',
                    'description'   => __( 'This specific slider displays the thumbnails in "rows" if you want your thumbnails displayed under the slider as a carousel, use the "Image Slider" module instead.', 'athen_transl' ),
                    'group'         => __( 'Thumbnails', 'athen_transl' ),
                    'value'         => array(
                ...
                array(
                    ...
                    'value'         => '',
                    'description'   => __( 'Enter a width in pixels for your thumbnail image width. This won\'t increase the grid, its only used so you can alter the cropping to your preferred proportions.', 'athen_transl' ),
                    'group'         => __( 'Thumbnails', 'athen_transl' ),
                    'edit_field_class'  => 'vc_col-sm-6 vc_column clear',
                ),
                array(
                    ...
                    'value'         => '',
                    'description'   => __( 'Enter a width in pixels for your thumbnail image height.', 'athen_transl' ),
                    'group'         => __( 'Thumbnails', 'athen_transl' ),
                    'edit_field_class'  => 'vc_col-sm-6 vc_column',
                ),
