 ...
 * @since 2.0.0
 */
class WPBakeryShortCode_vcex_parallax_bg extends WPBakeryShortCode {
    protected function content( $atts, $content = null ) {
        ob_start();
        include( locate_template( 'vcex_templates/vcex_parallax_bg.php' ) );
        return ob_get_clean();
    }
}
 ...
 * @since Total 1.4.1
 */
if ( ! function_exists( 'vcex_parallax_bg_shortcode_vc_map' ) ) {
    function vcex_parallax_bg_shortcode_vc_map() {

        vc_map( array(
            'name'                  => __( 'Parallax Background', 'athen_transl' ),
            'description'           => __( 'Parallax row effect', 'athen_transl' ),
            'base'                  => 'vcex_parallax_bg',
            ...
            'params'                => array(
                ...
                array(
                    'type'          => 'attach_image',
                    'admin_label'   => true,
                    'heading'       => __( 'Parallax Image 1', 'athen_transl' ),
                    'description'   => __( 'Give your main element a unique ID.', 'athen_transl' ),
                    'param_name'    => 'image_id1',
                ),
                array(
                    'type'          => 'attach_image',
                    'admin_label'   => true,
                    'heading'       => __( 'Parallax Image 2', 'athen_transl' ),
                    'description'   => __( 'Give your main element a unique ID.', 'athen_transl' ),
...
add_action( 'vc_before_init', 'vcex_parallax_bg_shortcode_vc_map' );