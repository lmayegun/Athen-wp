...
if ( ! function_exists( 'vcex_woocommerce_carousel_shortcode_vc_map' ) ) {
    function vcex_woocommerce_carousel_shortcode_vc_map() {
        ...
        // Add VC params
        vc_map( array(
            'name'                  => __( 'WooCommerce Carousel', 'athen_transl' ),
            'description'           => __( 'Recent woocommerce posts carousel', 'athen_transl' ),
            ...
            'params'                => array(
                ...
                array(
                    'type'          => 'dropdown',
                    'heading'       => __( 'Featured Products Only', 'athen_transl' ),
                ...
                array(
                    'type'          => 'dropdown',
                    'heading'       => __( 'Exclude Out of Stock Products', 'athen_transl' ),
                ...
                array(
                    'type'          => 'dropdown',
                    'heading'       => __( 'Display Price', 'athen_transl' ),
                    'param_name'    => 'price',
                    'value'         => array(
                        __( 'Yes', 'athen_transl')  => 'true',
                        __( 'No', 'athen_transl' )  => 'false',
                    ),
                    'group'         => __( 'Price', 'athen_transl' ),
                ),
                array(
                    'type'          => 'colorpicker',
                    'heading'       => __( 'Price Text Color', 'athen_transl' ),
                    'param_name'    => 'content_color',
                    'group'         => __( 'Price', 'athen_transl' ),
                ),
                array(
                    'type'          => 'textfield',
                    'heading'       => __( 'Price Font Size', 'athen_transl' ),
