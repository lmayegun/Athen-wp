...
if ( get_theme_mod( 'athen_customizer_typography_cache' ) || get_theme_mod( 'athen_customizer_css_cache' ) || get_theme_mod( 'portfolio_enable' ) || get_theme_mod( 'theme_branding' ) || get_theme_mod( 'extend_visual_composer' ) || get_theme_mod( 'header_style' ) || get_theme_mod( 'main_layout_style' ) || get_theme_mod( 'footer_copyright_text' ) || get_theme_mod( 'callout_text' ) || is_array( get_theme_mod( 'widget_areas' ) ) ) {

    // Update option
    update_option( 'athen_customizer_migration_complete', 'completed' );
...
class WPEX_Migrate_Redux {
    ...
    public function __construct() {
        ...
        $this->redux_options = get_option( 'athen_options' );
    ...
    public function migrate_settings() {
        ...
        // Get options
        $options = get_option( 'athen_options' );
