...
// Start Class
if ( ! class_exists( 'Athen_Image_Resize' ) ) {

    class Athen_Image_Resize {
        ...
        public function __construct() {
            $this->retina_enabled = athen_get_mod( 'retina', false );
            $this->retina_enabled = apply_filters( 'athen_image_resize_retina', $this->retina_enabled );
        }
        ...
        public function process( $args ) {
            ...
            if ( $crop && athen_get_mod( 'image_resizing', true ) ) {
                if ( is_array( $crop ) ) {
...
if ( ! function_exists( 'athen_image_resize' ) ) {
    function athen_image_resize( $args ) {
        $class = new Athen_Image_Resize;
