...
if ( ! class_exists( 'WPEX_Custom_Sidebars' ) ) {
	class WPEX_Custom_Sidebars {
		...
		public function __construct( $widget_areas = array() ) {
			...
			add_action( 'wp_ajax_athen_delete_widget_area', array( $this, 'athen_delete_widget_area' ) ); 
		}
				...
				<div id="wpex-add-widget" class="widgets-holder-wrap">
				 <div class="">
				  ...
				  <div class="sidebar-name">
				   <h3><?php echo __( 'Create Widget Area', 'athen_transl' ); ?> <span class="spinner"></span></h3>
				  </div>
				  <div class="sidebar-description">
					<form id="addWidgetAreaForm" action="" method="post">
					  <div class="widget-content">
						<input id="wpex-add-widget-input" name="wpex-add-widget-input" type="text" class="regular-text" title="<?php echo __( 'Name', 'athen_transl' ); ?>" placeholder="<?php echo __( 'Name', 'athen_transl' ); ?>" />
					  </div>
					  <div class="widget-control-actions">
						<div class="aligncenter">
						  <input class="addWidgetArea-button button-primary" type="submit" value="<?php echo __( 'Create Widget Area', 'athen_transl' ); ?>" />
						</div>
						<br class="clear">
					  </div>
					</form>
		...
		public function register_sidebars() {
			...
			$tag = athen_get_mod( 'sidebar_headings', 'div' ) ? athen_get_mod( 'sidebar_headings', 'div' ) : 'div';
		...
		public function get_widget_areas() {
			...
			$widget_areas = athen_get_mod( 'widget_areas' );
		 ...
		 * @since 1.6.0
		 */
		public function athen_delete_widget_area() {
		...
		public function scripts(){
			...
			$assets_dir = ATHEN_FRAMEWORK_DIR_URI .'addons/assets/widget-areas/';
			...
			wp_localize_script(
				...
				array(
					...
					'delete'	=> __( 'Delete', 'athen_transl' ),
					'confirm'	=> __( 'Confirm', 'athen_transl' ),
					'cancel'	=> __( 'Cancel', 'athen_transl' ),
				)
			);
		}
