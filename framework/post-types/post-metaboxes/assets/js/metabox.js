( function( $ ) {
	...
	$( document ).ready( function() {
		...
		( function wpexTitleSettings() {
			var field				= $( 'div#wpex-metabox select#athen_post_title_style' ),
				value				= field.val(),
				pageTitleBgSettings	= $( '#athen_post_title_background_color_tr, #athen_post_title_background_redux_tr,#athen_post_title_height_tr,#athen_post_title_background_overlay_tr,#athen_post_title_background_overlay_opacity_tr'),
				solidColorElements		= $( '#athen_post_title_background_color_tr');
