<?php
/**
 * Description  : Class for generating flickr images - see widgets.
 * 
 * @package     Athen
...
// Start class
if ( ! class_exists( 'Athen_Flickr_Widget' ) ) {
    class Athen_Flickr_Widget extends WP_Widget {
        ...
        public function __construct() {
            ...
            parent::__construct(
                'athen_flickr',
                $name = ATHEN_NAME_THEME . ' - '. __( 'Flickr Stream', 'athen_transl' ),
                array(
                    'description' => __( 'Pulls in images from your Flickr account.', 'athen_transl' )
                )
            );
        ...
        function form( $instance ) {
            ...
            <p>
                ...
                <?php _e( 'Flickr ID ', 'athen_transl' ); ?>:</label>
            ...
            <p>
                ...
                <?php _e( 'Number:', 'athen_transl' ); ?></label>
...
if ( ! function_exists( 'register_athen_flickr_widget' ) ) {
    function register_athen_flickr_widget() {
        register_widget( 'Athen_Flickr_Widget' );
    }
}
add_action( 'widgets_init', 'register_athen_flickr_widget' );