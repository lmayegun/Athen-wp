<?php
/**
 * Description  : Class for generating simple menu widget.
 * 
 * @package     Athen
...
if ( ! class_exists( 'WPEX_Simple_Menu' ) ) {
	class Athen_Simple_Menu extends WP_Widget {
		...
		function __construct() {
			parent::__construct(
				'athen_simple_menu',
				ATHEN_NAME_THEME . ' - '. __( 'Simple Menu', 'athen_transl' ),
				array( 'description' => __( 'Displays a custom menu without any toggles or styling.', 'athen_transl' ) )
			);
		}
...
if ( ! function_exists( 'register_athen_simple_menu' ) ) {
	function register_athen_simple_menu() {
		register_widget( 'Athen_Simple_Menu' );
	}
}
add_action( 'widgets_init', 'register_athen_simple_menu' );