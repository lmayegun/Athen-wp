...
<div id="view" class="social-share-wrap group clr position-<?php echo $position; ?><?php if ( 'full-screen' == $athen_std_theme->post_layout ) echo ' container'; ?>">
	...
	<ul class="list group position-<?php echo $position; ?> style-<?php echo $style; ?> clr">
		...
		<?php foreach ( $sites as $site ) : ?>
			...
			if ( 'twitter' == $site ) {
				...
				<li class="share-twitter link">
					<a href="http://twitter.com/share?text=<?php echo $title; ?>&amp;url=<?php echo $url; ?>" target="_blank" title="<?php _e( 'Share on Twitter', 'athen_transl' ); ?>" rel="nofollow" class="<?php echo $tooltip_class; ?>" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;">
						...
						<span class="social-share-button-text"></span>
					</a>
				</li>
			...
			elseif ( 'google_plus' == $site ) { ?>
				...
				<li class="share-googleplus link">
