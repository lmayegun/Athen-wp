...
if ( athen_gallery_is_lightbox_enabled() || athen_get_mod( 'blog_entry_image_lightbox' ) ) {
    $lightbox_enabled = true;
    athen_enqueue_ilightbox_skin(); // Load lightbox skin stylesheet
} else {
...
<div class="blog-entry-media clr">
    ...
    <div class="gallery-format-post-slider">
        ...
        <div class="wpex-slider slider-pro" <?php athen_blog_slider_data_atrributes(); ?>>
                        ...
                        // Display attachment image
                            ...
                            <div class="wpex-slider-media clr">
                                ...
                                if ( $lightbox_enabled ) : ?>
                                    ...
                                    <a href="<?php echo $lightbox_url; ?>" title="<?php echo $attachment_alt; ?>" data-title="<?php echo $attachment_alt; ?>" data-type="image" class="lightbox-group-item<?php athen_entry_image_animation_classes(); ?>"><?php echo $attachment_html; ?></a>
            ...
            if ( 'large-image-entry-style' == athen_blog_entry_style() ) : ?>
