...
<article id="post-<?php the_ID(); ?>" <?php post_class( array( 'custom-posttype-entry' ) ); ?>>
    ...
    if ( has_post_thumbnail() ) : ?>
        ...
        <div class="custom-posttype-entry-media">
            ...
            <a href="<?php athen_permalink(); ?>" title="<?php athen_esc_title(); ?>" rel="bookmark" class="custom-posttype-entry-media-link <?php athen_entry_image_animation_classes(); ?>">
                <?php
    ...
    <div class="custom-posttype-entry-content clr">
        ...
        <div class="custom-posttype-entry-readmore clr">
            ...
            <a href="<?php athen_permalink(); ?>" class="theme-button" title="<?php athen_esc_title(); ?>">
                <?php _e( 'Read more', 'athen_transl' ); ?><span class="wpex-hidden readmore-rarr">&rarr;</span>
            </a><!-- .theme-button -->
