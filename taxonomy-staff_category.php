...
/**
 * 
 * Description : Template for displaying category archives for staff post-type. 
 * 
 * @package     Athen
            ...
            <div id="primary" class="content-area clr">
                ...
                <main id="content" class="site-content clr" role="main">
                    ...
                    <?php if ( have_posts( ) ) : ?>
                        ...
                        <div id="staff-entries" class="<?php echo athen_get_staff_wrap_classes(); ?>">
                            ...
                            <?php while ( have_posts() ) : the_post(); ?>
                                ...
                                <?php if ( $athen_count == athen_staff_archive_columns() ) $athen_count=0; ?>
