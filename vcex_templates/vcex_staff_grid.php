				...
				<div <?php post_class( $entry_classes ); ?>>
						...
						<div class="<?php echo $media_classes; ?>">
							<?php if ( ! in_array( $thumb_link, array( 'none', 'nowhere' ) ) ) : ?>
								...
								if ( $thumb_link == 'lightbox' ) : ?>
									...
									<a href="<?php athen_lightbox_image(); ?>" title="<?php athen_esc_title(); ?>" class="staff-entry-media-link<?php echo $lightbox_single_class; ?>"<?php echo $lightbox_data; ?>>

								<?php else : ?>

									<a href="<?php echo $post->permalink; ?>" title="<?php athen_esc_title(); ?>" class="staff-entry-media-link"<?php echo vcex_html( 'target_attr', $link_target ); ?>>
					...
					if ( 'true' == $title || 'true' == $excerpt || 'true' == $read_more || 'true' == $position ) : ?>
						...
						<div class="staff-entry-details clr" <?php echo $content_style; ?>>
							...
							if ( 'true' == $title ) : ?>
								...
								<h2 class="staff-entry-title entry-title"<?php echo $heading_style; ?>>
									...
									if ( 'post' == $title_link ) : ?>
										...
										<a href="<?php echo $post->permalink; ?>" title="<?php athen_esc_title(); ?>"<?php echo $heading_link_style; ?><?php echo vcex_html( 'target_attr', $link_target ); ?>><?php the_title(); ?></a>
									...
									elseif ( 'lightbox' == $title_link ) : ?>
										...
										<a href="<?php athen_lightbox_image(); ?>" title="<?php athen_esc_title(); ?>"<?php echo $heading_link_style; ?> class="wpex-lightbox"><?php the_title(); ?></a>
							...
							if ( 'true' == $position && $get_position = get_post_meta( $post->ID, 'athen_staff_position', true ) ) : ?>
							...
							if ( 'true' == $show_categories ) : ?>
								...
								<div class="staff-entry-categories clr"<?php echo $categories_style; ?>>
									<?php if ( $show_first_category_only ) { ?>
										<?php athen_first_term_link( $post->ID, 'staff_category' ); ?>
									<?php } else { ?>
