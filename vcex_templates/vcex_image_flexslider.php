...
if ( $attachments ) :
    ...
    if ( 'false' != $preloader_img ) : ?>
        ...
        <div class="wpex-slider-preloaderimg">
            ...
            <?php athen_post_thumbnail( array(
    ...
    <div class="<?php echo $wrap_classes; ?>"<?php vcex_unique_id( $unique_id ); ?><?php echo $wrap_data; ?>>
        ...
        <div class="wpex-slider-slides sp-slides">
            ...
            foreach ( $attachments as $attachment => $custom_link ) : ?>
                ...
                $attachment_video   = athen_add_sp_video_to_oembed( $attachment_video );

                // Generate img HTML
                $attachment_img = athen_get_post_thumbnail( array(
                    ...
                    <div class="wpex-slider-media">
                        ...
                        <?php elseif( $attachment_img ) : ?>
                            ...
                            <?php if ( 'lightbox' == $thumbnail_link ) {
                                ...
                                <a href="<?php athen_lightbox_image( $attachment ); ?>" title="<?php echo esc_url( $attachment_data['title'] ); ?>" class="vcex-flexslider-entry-img lightbox-group-item"<?php echo $lightbox_data_attributes; ?>>
